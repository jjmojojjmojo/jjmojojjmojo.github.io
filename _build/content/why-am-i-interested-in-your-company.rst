...
######################################
:date: 2026-05-29 10:54
:author: jjmojojjmojo
:category: musings
:tags: musings; hiring
:slug: why-am-i-interested-in-your-company
:status: published
...
.. quote::
    ...
    "As a software leader with over 25 years of experience transforming culture at key inflection points, I've heavily leveraged :code:`${TECHNOLOGY_FROM_POST}` to increase :code:`${SOME_METRIC}` while protecting :code:`${SOMETHING_OF_VALUE}`. I'm really interested in :code:`${COMPANY}` because it's proven to :code:`${LIFTED_DETAIL_FROM_COMPANY_BLOG}` and I love :code:`${SOMETHING_CEO_SAID}`, I feel it really gels with my work style."

Those variables are interchangeable for any post, any company. The ubiquity of these questions implies that this would be acceptable, right? Ok, sure, but what signal is that sending? I mean that in the sense of a signal to the person making hiring decisions, but also what is it saying *to me*, the applicant? I think you *want* me to be formulaic. But that doesn't reconcile with the explanations I've found (like these from `Indeed <https://www.indeed.com/career-advice/interviewing/interview-question-why-do-you-want-to-work-here>`__,  `Harvard Business Review <https://hbr.org/2022/08/how-to-answer-why-do-you-want-to-work-here>`__, `MIT's CDO <https://hbr.org/2022/08/how-to-answer-why-do-you-want-to-work-here>`__, and `Ask A Manager <https://www.askamanager.org/2019/07/how-to-answer-why-are-you-interested-in-this-job.html>`__) - it seems that this question is actually asking for something bespoke and creative (but of course, not *too* creative...right?).
...
These complaints, and these questions, have existed as long as I've been in the industry (est. 1999 |cool|). Yet both persist today, so the questions aren't working, right? Recent `reports <https://www.greenhouse.com/newsroom/an-ai-trust-crisis-70-of-hiring-managers-trust-ai-to-make-faster-and-better-hiring-decisions-only-8-of-job-seekers-call-it-fair>`__ of generative AI making the process so much more difficult for those hiring, and those looking for work, further make me wonder: what's the real issue here?

.. quote:: Greenhouse Software, "An AI Trust Crisis: 70% of Hiring Managers Trust AI to Make Faster and Better Hiring Decisions, Only 8% of Job Seekers Call it Fair"
    :link:  https://www.greenhouse.com/newsroom/an-ai-trust-crisis-70-of-hiring-managers-trust-ai-to-make-faster-and-better-hiring-decisions-only-8-of-job-seekers-call-it-fair
...
Now, I'm **not** a cynic. While my overall worldview is deeply pragmatic, when it comes to the toil of labor, I'm uncharacteristically optimistic. |rainbow| 
...
The reality is that job boards and hiring platforms are rarely where companies find talent. It's an open secret in the industry that personal networks yield more candidates that get hired than any other source. This `2025 report from Ashby <https://www.ashbyhq.com/talent-trends-report/reports/referrals>`__ illustrates this.

.. quote:: Ashby, Inc., "Are referred candidates more likely to get hired?", Joel Westmark, May 15, 2025
    :link: https://www.ashbyhq.com/talent-trends-report/reports/referrals
    
    "Despite representing smaller pieces of the application sources pie, candidates from referred, internal, and agency are moving through the hiring process at a strong rate. Referred and internal candidates are often seen as lower risk as they come “validated” from employees. Across all jobs, candidates from internal, referred, and agency were found to be more likely to get interviews than inbound applicants — and be hired after an interview"
    
    **Internal Candidates**
    
    * 42% of internal candidates go from application to interview
    * Out of internal candidates interviewed, 32% go from interview to offer
    * Some internal applicants are hired without a formal interview
    
    **Referred Candidates**
    
    * 40% of referred candidates go from application to interview
    * Out of referred candidates interviewed, 16% go to an offer stage
    
    **Agency Candidates**
    
    * 42% of agency candidates go from application to interview
    * Out of agency candidates interviewed, 8% go from interview to offer
...
.. quote:: Ashby, Inc., "Are referred candidates more likely to get hired?", Joel Westmark, May 15, 2025
    ...
    "...Though the absolute change is relatively small, in relative terms inbound applications experienced a ~70% reduction in offer rates (7 in 1000 to 2 in 1000), the largest decrease of any application source. This correlates with inbound volume tripling in the past few years. However, as found in our *Offer Acceptance Talent Trends report*, we know that inbound applicants remain the dominant source of all hires made. This finding is consistent with the general theme of more scrutiny, evaluation, and effort in vetting the inbound application source to find great talent, while also suggesting that hiring is currently an employer's market."
...
I've had a fairly long career. I've seen some stuff. And I can tell you, way before generative AI, way before `North Korea was using AI to infiltrate US tech companies <https://techcrunch.com/2025/08/04/north-korean-spies-posing-as-remote-workers-have-infiltrated-hundreds-of-companies-says-crowdstrike/>`__, the complaints were exactly the same: there are too many applicants (except when there aren't), candidates are awful, they all lie, and as a hiring manager, I can't afford a bad hire.
...
I think that's a natural aspect of how social animals, including human beings, are wired. We seek similarity in our social cohorts (it's the concept of `homophily <https://en.wikipedia.org/wiki/Homophily>`__).
...
I won't get into the compliance issues here, as it seems to be a touchy subject within the industry. I mean, how can a company *disrupt 10x max paradigm agentic revenue funnel* if it's restricted by red tape! |heartbreak| But seriously, it's a subject whose implications vary so much from one location or work context to another that, even if I were qualified to speak to it (I very much am not), I'd probably be saying the wrong thing.

.. note::
   
   This is what HR professionals are for. |heart|
   

But the danger of monoculture is a real threat to the ability of a company to create an environment where people thrive. Diverse people, from diverse backgrounds, make better technical decisions. I've witnessed this firsthand, and there is research to back this up (links of interest: `Gender diversity leads to better science <https://www.pnas.org/doi/full/10.1073/pnas.1700616114>`__, and `Groups of diverse problem solvers can outperform groups of high-ability problem solvers <https://pmc.ncbi.nlm.nih.gov/articles/PMC528939/>`__).

What I see in the literature crystallizes what I said earlier: an environment where talented people are given the space to thrive enables them to excel. There's also research that points to the potential difficulties (`one example <https://pmc.ncbi.nlm.nih.gov/articles/PMC9947786/>`__), but in my view, the potential need for greater empathy and sensitivity, difficult conversations, adjusting our linguistic code (see `code switching <https://en.wikipedia.org/wiki/Code-switching>`__), and adjusting our tolerance for divergent perspectives *is* what creates that environment. 
...
.. note::
    Hey, I'm bad at this too! This is hardly a comprehensive list. But we can figure this out together. `Reach out directly <{filename}/pages/contact.rst>`__ and let's chat about it.
...
Get proactive. This might terrorize certain managers (you know who), but here lies a great opportunity to *write a little code*. There are some offerings for resume databases (`OpenCATS <https://github.com/opencats/OpenCATS>`__ for example), but hey, you can do this. And if you can't, I know I just said you shouldn't be using an LLM to filter out LLM-generated responses, but a quick, temporary index and search system can be had with an afternoon of vibe coding, if you can't manage otherwise.
...
I can hear the thread on `/r/recruitinghell <https://www.reddit.com/r/recruitinghell/>`__ already:

.. quote:: 
    
    "That's all great but I'm *swamped*. It's *impossible* to look at every resume that crosses my desk. I mean, I can barely meet my deliverables for the quarter, I don't have time to go have a goshdarn *tea party* with every programmer in my area."
...
1. We can pretend it's not, but *hiring is the job*. It's especially relevant when your organization is growing. You can't outsource it, you can't ignore it. Ultimately it's your responsibility. You have to embrace it.
2. If you don't have the time to do the job, that means you have a resource allocation problem, you're having a skills issue, or you need to face the fact that this is not a good time for growth. It's your responsibility to figure it out and have these tough conversations with leadership. 
...
.. quote::
    ...
    "But I don't want to waste my time on a candidate that won't work out!"
...
Doing the difficult work is what makes us great. Digging in, you may find the best hire of your career, or you might not. But through the process, you will learn along the way. Maybe you'll grow as a leader, become more diplomatic, reduce your biases... you know, emerge as your unique unicorn self |unicorn|.
